...
function MyReservations() {
    ...
    return (
        <div className="bg-black text-white overflow-x-hidden relative isolate">
                        ...
                        <div className="mt-20 bg-white/5 border border-white/10 rounded-[3rem] p-10 lg:p-20 backdrop-blur-xl text-center relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="mt-6 text-zinc-400 text-lg leading-relaxed max-w-2xl mx-auto">
                                    ...
                                    Cuando reserves un servicio, podrás visualizar aquí
                                    todos los detalles de tus próximas citas.
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-10 bg-black/30 border border-white/10 rounded-2xl p-6">
                                                    ...
                                                    <p className="mt-4 text-zinc-400 leading-relaxed">
                                                        ...
                                                        Para proteger la agenda de los profesionales,
                                                        las solicitudes de cancelación y reagendamiento
                                                        deben realizarse con anticipación y serán
                                                        revisadas por el negocio correspondiente.
